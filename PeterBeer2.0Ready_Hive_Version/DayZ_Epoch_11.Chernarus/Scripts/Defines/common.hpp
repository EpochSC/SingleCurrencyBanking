class Life_RscScrollBar
{
	...
	thumb = "zupa\gui\thumb_ca.paa";
	arrowEmpty = "zupa\gui\arrowEmpty_ca.paa";
	arrowFull = "zupa\gui\arrowFull_ca.paa";
	border = "zupa\gui\border_ca.paa";
	shadow = 0;
	scrollSpeed = 0.06;
	width = 0;
	height = 0;
...
class Life_RscTree {
	...
	expandedTexture = "zupa\gui\expandedTexture_ca.paa";
	hiddenTexture = "zupa\gui\hiddenTexture_ca.paa";
	rowHeight = 0.0439091;
	color[] = {1, 1, 1, 1};
...
class Life_RscShortcutButton {
	...
	animTextureDefault = "zupa\gui\normal_ca.paa";
	animTextureNormal = "zupa\gui\normal_ca.paa";
	animTextureDisabled = "zupa\gui\normal_ca.paa";
	animTextureOver = "zupa\gui\over_ca.paa";
	animTextureFocused = "zupa\gui\focus_ca.paa";
	animTexturePressed = "zupa\gui\down_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class Life_RscShortcutButtonMain : Life_RscShortcutButton {
	...
	animTextureNormal = "zupa\gui\main\normal_ca.paa";
	animTextureDisabled = "zupa\gui\main\disabled_ca.paa";
	animTextureOver = "zupa\gui\main\over_ca.paa";
	animTextureFocused = "zupa\gui\main\focus_ca.paa";
	animTexturePressed = "zupa\gui\main\down_ca.paa";
	animTextureDefault = "zupa\gui\main\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class life_RscXSliderH 
{
	...
	arrowEmpty = "zupa\gui\slider\arrowEmpty_ca.paa";
	arrowFull = "zupa\gui\slider\arrowFull_ca.paa";
	border = "zupa\gui\slider\border_ca.paa";
	thumb = "zupa\gui\slider\thumb_ca.paa";
};
...
class Life_RscHTML {
	...
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "zupa\gui\arrow_left_ca.paa";
	nextPage = "zupa\gui\arrow_right_ca.paa";
	shadow = 2;
	class H1 {
		font = "Zeppelin32";
		fontBold = "Zeppelin32";
...
class Life_RscCombo {
	...
	arrowFull = "zupa\gui\arrowFull_sca.paa";
	arrowEmpty = "zupa\gui\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	color[] = {1, 1, 1, 1};
	colorActive[] = {1, 0, 0, 1};
