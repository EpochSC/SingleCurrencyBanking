//Zupa - Currency Compiles - be sure to call this after the normal compiles! it overwrite some trader functions
...
SC_GiveTarget = objNull;

SC_fnc_removeCoins =  compile preprocessFileLineNumbers "zupa\functions\SC_RemoveCoins.sqf";
SC_fnc_addCoins =   compile preprocessFileLineNumbers "zupa\functions\SC_AddCoins.sqf";
BIS_fnc_numberDigits = compile preprocessFileLineNumbers "zupa\functions\numberDigits.sqf";
BIS_fnc_numberText = compile preprocessFileLineNumbers "zupa\functions\numberText.sqf"; 
...
TraderDialogBuy = {
	...
	_data execVM "zupa\actions\trade_items_buy.sqf";
...
TraderDialogSell = {
	...
	_data execVM "zupa\actions\trade_items_sell.sqf";
