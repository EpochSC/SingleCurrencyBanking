...
/*  NORMAL ADMIN HERE     */ _NormalLevel_List =["15037894","76561198147154777","0"]; //do not have a , at the end.
/*  SUPER ADMIN HERE      */ _SuperLevel_List = ["76561197978292656","76561198012464696","76561198061372184","76561198088232726","76561198115091675","68878790","155634182","111010182","167174726","122856390"]; //do not have a , at the end.     
/*  BANNED PLAYER HERE    */ _BLOCKED =         ["0","0","0"]; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "Amnesia"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "ts3: 85.25.213.236"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "amnesiagaming.enjin.com"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "ts3: 85.25.213.236"; //do not use " in this text.
