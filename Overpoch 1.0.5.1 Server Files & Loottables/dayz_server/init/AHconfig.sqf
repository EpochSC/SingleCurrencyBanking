...
/*  SUPER ADMIN HERE      */ _SuperLevel_List = ["159940294","147825734","68878790"]; //do not have a , at the end.
/*  BANNED PLAYER HERE    */ _BLOCKED =         ["0","0","0"]; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "DayZ Server"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "Dev"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "Zupa"; //do not use " in this text.
