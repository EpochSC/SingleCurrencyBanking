...
TraderDialogLoadItemList = {
	...
	_item_list = [];
	{
		...
		Switch (_name) do {
			case "ATV_CZ_EP1": {_textPart = "ATV Custom Camo";};
			case "ATV_US_EP1": {_textPart = "ATV Custom Camo2";};
			case "SUV_Silver_DZE1": {_textPart = "SUV Custom Murica";};
			case "SUV_TK_CIV_EP1_DZE1": {_textPart = "SUV Custom Grey";};
			case "SUV_Green_DZE2": {_textPart = "SUV Custom Green";};
			case "SUV_Yellow_DZE1": {_textPart = "SUV Hello Kitty";};
			default {_textPart = getText(configFile >> _type >> _name >> "displayName");};
		};
