...
execVM  "\z\addons\dayz_server\objects\ChernoRoadblock.sqf";
execVM  "\z\addons\dayz_server\objects\DevilsCastle.sqf";
execVM "\z\addons\dayz_server\objects\NWAF.sqf";
execVM  "\z\addons\dayz_server\objects\sosnwaf.sqf";
