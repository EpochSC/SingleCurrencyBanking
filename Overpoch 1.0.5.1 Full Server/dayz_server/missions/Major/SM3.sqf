...
//These are heavily modified, I removed the temporary vehicles, and I added these messages.
_hMSG = "<t align='center' color='#52bf90' shadow='2' size='1.75'>AI Mission</t><br/><t align='center' color='#ffffff'>Bandits have set up a medical re-supply camp! Check your map for the location!</t>";
...
sleep 0.5;
_sMSG2 = "RANDOM EVENT: Bandits have set up a medical re-supply camp! Check your map for the location!";
